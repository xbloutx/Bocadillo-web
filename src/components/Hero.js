...
export default function Hero() {
    ...
    <section className="bg-bocadillo-antique overflow-hidden">
        <div className="grid lg:grid-cols-2 items-center max-w-[1700px] mx-auto px-6 md:px-12 lg:px-20 min-h-[vh] py-12 lg:py-0">

            <div className="flex flex-col items-center lg:items-start text-center lg:text-left py-8 lg:py-20">
            ...
            <div className="relative flex items-center justify-center h-[350px] sm:h-[450px] lg:h-[600px] w-full mt-8 lg:mt-0">
                <Image
